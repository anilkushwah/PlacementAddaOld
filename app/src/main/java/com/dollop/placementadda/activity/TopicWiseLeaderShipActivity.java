...
public class TopicWiseLeaderShipActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkNetworkAvailability(TopicWiseLeaderShipActivity.this);
...
//        topicWiseRv = findViewById(R.id.topicWiseRv);
        ...
        topicIdStr = filteredHistory.getTopic_id();
        getLeaderBoardRanks();
        BroadcastReceiver broadcastReceiver = S.LocalBroadcastReciver(TopicWiseLeaderShipActivity.this);
    ...
    private void getLeaderBoardRanks() {
        new JSONParser(TopicWiseLeaderShipActivity.this).parseVollyStringRequest(Const.URL.getUserRankingTopicVise, 1, getParmsans(), new Helper() {
            ...
            public void backResponse(String response) {
                try {
                    ...
                    if (status == 200) {
                        ...
                        pdfAdapter = new LeaderBoardAdapter(TopicWiseLeaderShipActivity.this, leaderBoardModelArrayList,0);
                        leaderBoardRecyclerView.setLayoutManager(new LinearLayoutManager(TopicWiseLeaderShipActivity.this));
                        leaderBoardRecyclerView.setAdapter(pdfAdapter);
                    } else {
                        S.T(TopicWiseLeaderShipActivity.this, "" + message);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    private Map<String, String> getParmsans() {
        ...
        params.put("topic_id", topicIdStr);
        return params;
    }
}
