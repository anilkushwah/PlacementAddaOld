...
public class QuizesActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkNetworkAvailability(QuizesActivity.this);
     ...
     // topicId =  bundle.getString("Subjecttopic_ID");
        ...
        BroadcastReceiver broadcastReceiver = S.LocalBroadcastReciver(QuizesActivity.this);
    ...
    private void getQuizList() {
        new JSONParser(QuizesActivity.this).parseVollyStringRequest(Const.URL.GetQuiz, 1, getParms(), new Helper() {
                ...
                try {
                    ...
                    if (status == 200) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            quizListModel.setQuizCategory_id(Subjecttopic_ID);
                            quizSubCatModelList.add(quizListModel);
                        }
                        QuizesListAdapter quizCategoryAdapter = new QuizesListAdapter(QuizesActivity.this, quizSubCatModelList);
    ...
    public void getSelectedQuiz(String Quiz_id, String Quiz_time, String QuizCategory_id) {
        if (ActivityCheck.equals("QuizCategery")) {
            ...
            S.I(QuizesActivity.this, ExamInstructionActivity.class, bundle);
            ...
            if (Member_number.equals("2")) {
                ...
                S.I(QuizesActivity.this, QuizPlayDetailsActivity.class, bundle);
