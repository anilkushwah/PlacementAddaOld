...
import com.dollop.placementadda.activity.intro.SubjectTopicActivity;
...
public class QuizSubjectAdapter extends RecyclerView.Adapter<QuizSubjectAdapter.MyViewHolder> {
    Context context;
    List<QuizCategoryModel> quizCategoryModelList;
    private SparseBooleanArray mSelectedItemsIds;

    public QuizSubjectAdapter(Context context, List<QuizCategoryModel> quizCategoryModelList) {
    ...
    @Override
    public QuizSubjectAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.data_quiz_category, parent, false);
        QuizSubjectAdapter.MyViewHolder viewHolder = new QuizSubjectAdapter.MyViewHolder(v);
        return viewHolder;
    }
    ...
    @Override
    public void onBindViewHolder(final QuizSubjectAdapter.MyViewHolder holder, final int position) {
...
*/
        ...
        holder.categryLayoutCardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                S.I(context, SubjectTopicActivity.class, bundle);
            }
        });
    }
