...
public class QuizesListAdapter extends RecyclerView.Adapter<QuizesListAdapter.MyViewHolder> {
    Context context;
    List<QuizListModel> QuizListModelList;
    private SparseBooleanArray mSelectedItemsIds;

    public QuizesListAdapter(Context context, List<QuizListModel> QuizListModelList) {
    ...
    @Override
    public QuizesListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.data_quiz_sub_category, parent, false);
        QuizesListAdapter.MyViewHolder viewHolder = new QuizesListAdapter.MyViewHolder(v);
        return viewHolder;
    }
    ...
    @Override
    public void onBindViewHolder(final QuizesListAdapter.MyViewHolder holder, final int position) {
        ...
        holder.mainCardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((QuizesActivity)context).getSelectedQuiz(subCatModel.getQuiz_id(),subCatModel.getQuizTime(),subCatModel.getQuizCategory_id());
            }
        });
    }
