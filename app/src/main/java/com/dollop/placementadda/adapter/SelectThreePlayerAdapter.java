...
public class SelectThreePlayerAdapter extends RecyclerView.Adapter<SelectThreePlayerAdapter.ViewHolder> {
    Context context;
    ...
    int trueCount=0;
    public SelectThreePlayerAdapter(Context context, List<LeaderBoardModel> leaderBoardModelList) {
    ...
    // Create new views
    @Override
    public SelectThreePlayerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.data_select_three_player, null);
        // create ViewHolder
        SelectThreePlayerAdapter.ViewHolder viewHolder = new SelectThreePlayerAdapter.ViewHolder(itemLayoutView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final SelectThreePlayerAdapter.ViewHolder viewHolder, final int position) {
